...
| 2 | **USGS Quaternary Fault & Fold Database** | USGS Earthquake Hazards | Interactive: https://www.usgs.gov/programs/earthquake-hazards/faults <br> ScienceBase: https://www.sciencebase.gov/catalog/item/589097b1e4b072a7ac0cae23 <br> DOI: https://doi.org/10.5066/P9BCVRCK <br> KML download: https://www.usgs.gov/programs/earthquake-hazards/google-earthtmkml-files <br> ArcGIS: https://earthquake.usgs.gov/arcgis/rest/services/haz/Qfaults/MapServer | Public Domain | Ground truth labels | Training labels source; we verify alignment, use for additional supervision |
| 3 | **USGS 3DEP 1m DEM / Lidar** | USGS National Geospatial Program | About: https://www.usgs.gov/3d-elevation-program/about-3dep-products-services <br> Downloader: https://apps.nationalmap.gov/downloader/ <br> LidarExplorer: https://apps.nationalmap.gov/lidar-explorer/ <br> AWS: https://registry.opendata.aws/usgs-lidar/ (via https://geodataviewer.com/datasets/dem/ned-3dep-usgs/) | Public Domain | Elevation detail | Official source for `1m_DEM_links.csv`; we compute slope, curvature, TRI, TPI, hillshade |
| 4 | **INGENIOUS Great Basin Regional Dataset Compilation** | GBCGE / DOE GDR | GDR: https://gdr.openei.org/submissions/1391 <br> DOI: https://doi.org/10.15121/1881483 <br> OSTI: https://www.osti.gov/biblio/1881483 <br> Project: https://gbcge.org/current-projects/ingenious/ | CC License, Publicly accessible | Features in challenge (conductivity, strain, gravity, etc.) | Source for conductivity, strain rate, gravity, earthquake density layers |
...
### Expected Gains
- Reference: ~0.45-0.55 DTI (estimated).
- Our ensemble + external DEM + TTA: target 0.65+ on public LB, which historically correlates with top 5.
