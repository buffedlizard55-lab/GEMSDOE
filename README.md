...
> [Sources](https://buffedlizard55-lab.github.io/GEMSDOE/docs/sources.html) ·
> [Reproduce](https://buffedlizard55-lab.github.io/GEMSDOE/docs/reproduce.html)
>
> Those pages are **generated by `scripts/build_site.py` from machine-measured evidence**
> (`data/evidence/*.json`) — every figure traces to a GitHub runner that downloaded the real
> files and measured them. **Current project status, including what does *not* work yet, is in
> [`STATUS.md`](STATUS.md).**
>
> ⚠️ Sections of this README below were written in earlier sessions and are **partly
