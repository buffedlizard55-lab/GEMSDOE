...
- [ ] **Literature review:** `docs/literature.md` + `docs/research.html` + `SUGGESTIONS.md` — deep research, 12+ papers verified, 15 improvements implemented, future suggestions
- [ ] **GitHub Pages:** `docs/index.html` clean UI, user-friendly, organized, with navigation, badges, alerts, tables, code blocks, dark header, sticky nav, responsive grid, plus additional pages `methodology.html`, `submission.html`, `data.html`, `research.html`
