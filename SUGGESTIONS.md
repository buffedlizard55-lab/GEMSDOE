...
| Fold-weighted blending | ✅ **measured & default-on** — equal weights: a weak fold (0.049 held-out) buried a strong one (0.150); softmax over held-out DTI (0.691/0.309) lifted the blended submission 0.0143 → 0.0984 (blanket floor 0.0955) on the 2-fold fixture toy | `data/evidence/runs/local-mini-ensemble/` |
